...
<main class="flex justify-center items-center h-screen">
	<div class="max-w-sm p-8 rounded-lg shadow-lg">
		...
		>
		<h1 class="text-2xl text-center mb-4">Oops! Something went wrong. We cannot sign you up</h1>
        ...
        class="hover:bg-green-five hover:text-steel-one rounded-full transition-all duration-500 ease-in-out"
			><button
				type="button"
				class="bg-green-500 hover:bg-green-600 text-white text-sm font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
			>
				Retry
			</button></a
		>
